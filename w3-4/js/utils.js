const getTime = () => {
    ...
    let times = new Array(`${currentTime.getFullYear()}년`, `${currentTime.getMonth()}월`, `${currentTime.getDay()}일`, `${currentTime.getHours()}시`, `${currentTime.getMinutes()}분`, `${currentTime.getSeconds()}입니다`);
    time.innerHTML = `${times[0]} ${times[1]} ${times[2]} ${times[3]} ${times[4]} ${times[5]}}`
    }, 1000)
}
